...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'Email already used' => 'Данный email уже используется',
    'Username already used' => 'Пользователь с таким логином уже зарегистрирован',
    'Unknown resource' => 'Комментируете неизвестно что',
    'Need text' => 'Комментарий должен содержать текст',
  ),
  'security' => 
  array (
  ...
  'messages' => 
  array (
    'Confirmation success' => 'Регистрация успешна, вы можете войти используя ваши логин и пароль',
    'Confirmation failure' => 'Ящик не найден или уже активирован',
    'You will be sent an email with a link to activate your account. Click on the link in the email to complete your registration.' => 'Вам отправлено письмо с сылкой на активацию аккаунта. Пройдите по ссылке в письме, чтобы завершить регистрацию.',
    'Username' => 'Имя пользователя',
    'Password' => 'Пароль',
    'Bad credentials.' => 'Нет такого',
    'Login' => 'Войти',
    'Sign in' => 'Войти',
    'Facebook login' => 'Войти через Facebook',
    'Sign Up' => 'Зарегистрироваться',
    'Welcome!' => 'Добро пожаловать!',
    'First Name' => 'Имя',
    'Last Name' => 'Фамилия',
    'Change you profile data' => 'Смена данных профиля',
    'Save' => 'Сохранить',
    'Simple Application Example' => 'Простой пример приложения',
    'Comment' => 'Добавить комментарий',
    'Change Profile' => 'Изменить данные',
    'Logout' => 'Выход',
    'Home' => '2GIs API Demo',
    'Please wait, you are will redirected' => 'Пожалуйста подождите, вы будете перемещены',
